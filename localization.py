...
strings = {
    ...
    "ru": {
        ...
        "announcements" : (
            {
                "message" : "🌀 Участники Артчата, не забывайте про команду <b>!report</b>, благодаря которой Вы можете обратить мое внимание на нарушителя в чате.\n<i>Кстати, Спам данной командой карается вечным баном.</i>",
                "every" : 1000
            },
            {
                "message" : "<b>Общаемся на тему искусства и всего, что с ним связано 👊</b>\n\n🕒 Все стикеры и медиа запрещены для новых участников\n🤬 Ненормативная лексика не запрещена, если не оскорбляет личность.
\n👽 Оффтоп наказывается мутами\n\n<b>Приятного общения 🥰</b>",
                "every" : 2000
            },
            {
                "message" : "<b>#творите 👾 любите жизнь и себя, 👽 открывайте новое, 😴 больше отдыхайте.</b>\n\n✌️ Будьте здоровы",
                "every" : 3000
            },
            {
                "message" : "🌿<b>Творцы и ценители!</b>\n Подписывайтесь на основной канал, если ещё этого не сделали:\n<i>@smackmyartup</i>",
                "every" : 4000
            },
            {
                "message" : "<b>Напоминаю о себе!</b>Я Артбот, создан для того, чтобы облегчить жизнь своей хозяйке в Артчате.\n<i>Пользуясь случаем передаю ей привет, а участников прошу сказать ей что-то от души! ☀️</i>",
                "every" : 5000
            },
            {
                "message" : "<b>Песню запе-вай!\n\n</b><i>
Твори добро\n
На всей Земле,\n
Твори добро\n
Другим во благо\n
